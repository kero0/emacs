...
(use-package tabspaces
  ...
  (my/general-global-menu! "Workspaces" "TAB"
    ...
    "d" '("Delete workspace" . tabspaces-close-workspace)
    "D" '("Delete workspace and kill buffers" . tabspaces-kill-buffers-close-workspace)
    "o" '("Open/Create project ws" . tabspaces-open-or-create-project-and-workspace)
    "s" '("Switch/Create ws" . tabspaces-switch-or-create-workspace)
    "TAB" '("Switch/Create ws" . tabspaces-switch-or-create-workspace)
    "t" '("Switch buffer and tab" . tabspaces-switch-buffer-and-tab)
...
(use-package dired
  ...
  :commands dired
  :config
  (my/general-global-Open "d" '("dired" . dired))
...
(use-package magit
  ...
  (my/general-global-Git
    ...
    "B" '("Blame here" . magit-blame-here)
    "S" '("Stage file" . magit-stage-file))
...
(use-package docker
  :commands docker
  :init (my/general-global-Open "D" 'docker))
#+end_src
** Latex
