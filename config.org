...
(eval-when-compile
  (require 'use-package)
  (advice-add #'use-package-handler/:bind :around #'eval-when-compile))
...
(my/general-global-menu! "Input-Language" "I"
...
(general-def
  "C-c l" (cons "Input-Language" my/general-global-Input-Language-map))
