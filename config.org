...
(use-package persp-mode
  :preface (my/general-global-menu! "Perspective" "P")
  :unless noninteractive
  :hook (after-init . persp-mode)
  :general (my/general-global-Perspective
  ...
  (defun my/persp-mode-rename ()
    "Rename perspective to current project name."
    (interactive)
    (let ((project-name (projectile-project-name)))
      (if (string= project-name "-")
          (persp-rename (buffer-name))
        (persp-rename project-name))))
  (add-hook 'persp-mode-hook #'my/persp-mode-rename)
...
(use-package ellama
  :general (my/leader-def
	     :infix "E"
	     "" '(:ignore t :wk "Ellama")
	     "E" '(ellama-chat :wk "Chat")
	     "s" '(ellama-summarize :wk "Summarize")
	     "c" '(ellama-complete-code))
  :init
