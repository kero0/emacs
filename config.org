...
(use-package julia-vterm
  ...
  :config
  (after! popper
	  (append! popper-reference-buffers "\\*julia:main\\*")
	  (popper-mode -1)
	  (popper-mode 1))
...
(use-package mu4e
  ...
  :init (add-to-list 'recentf-exclude my/mail-dir)
  :config
