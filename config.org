...
(use-package popper
  ...
  (defun my/kill-buffer-advice (orig-fn &rest args)
    ...
    (let ((buf (current-buffer)))
      ...
      (apply orig-fn args)))
  (add-hook 'kill-buffer-hook (lambda () (advice-add 'kill-buffer :around #'my/kill-buffer-advice))))
(when noninteractive
...
(use-package unicode-fonts
  ...
  :init
  (my/leader-def "U" '(insert-char :which-key "Insert Unicode char (by name)")))
#+end_src
** Dashboard
#+begin_src emacs-lisp
...
(use-package evil-fringe-mark
  ...
  (my/general-global-Toggle "f" '(evil-fringe-mark-mode :which-key "Evil Marks")))
#+end_src
...
(use-package dired
  ...
  :commands dired
  :config
  (my/general-global-Open "d" '(dired :which-key "dired"))
...
(use-package vterm
  ...
  :init (my/general-global-Open "t" '(vterm :which-key "vterm"))
  :config
...
(use-package mu4e
  ...
  (my/general-global-Open "m" '(mu4e :which-key "Email"))
  :config
