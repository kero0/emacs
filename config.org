...
(general-create-definer my/local-leader-def
  :prefix my/local-leader-def-prefix
  :global-prefix my/local-leader-def-prefix-alt
...
(defvar my/local-leader-def-prefix (concat my/leader-def-prefix " m")
  "Prefix for general.el local leader keybindings.")
(defvar my/local-leader-def-prefix-alt (concat my/leader-def-prefix-alt " m")
  "Alternative prefix for general.el local leader keybindings.")
...
(use-package evil-textobj-tree-sitter
  ...
  :if (and (package-installed-p 'evil) (package-installed-p 'tree-sitter))
  :config
...
(use-package persp-mode
  :init
  (setq persp-save-dir (concat my/cache-dir "persp/"))
  :config
  ...
  (my/general-global-menu! "Workspaces" "TAB"
    ...
    "TAB" '(persp-frame-switch :wk "Switch workspace")
    "n" '(persp-next :wk "Next workspace")
    "p" '(persp-prev :wk "Previous workspace")
    "c" '(persp-switch :wk "Create workspace")
    "r" '(persp-rename :wk "Rename workspace")
    "k" '(persp-kill :wk "Kill workspace")
    "a" '(persp-add-buffer :wk "Add buffer to workspace")
    "A" '(persp-remove-buffer :wk "Remove buffer from workspace")
    "s" '(persp-switch-to-buffer :wk "Switch to buffer in workspace")
    "S" '(persp-save-to-file-by-names :wk "Save workspace to file")
    "L" '(persp-load-from-file-by-names :wk "Load workspace from file"))
...
(when (and (package-installed-p 'projectile) (package-installed-p 'persp-mode))
  (use-package persp-mode-projectile-bridge
    :after (persp-mode projectile)
    :config (setq projectile-switch-project-action #'projectile-persp-switch-project)
...
(use-package haskell-mode
  ...
  (eval-after-load 'projectile (lambda ()
				 (add-to-list 'projectile-other-file-alist "hs")
				 (add-to-list 'projectile-other-file-alist "lhs")
...
(use-package pdf-tools
  ...
  ;; remove from recentf and undo-tree
