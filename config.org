* Setup
#+PROPERTY: header-args :tangle config.el :results output silent :noweb yes :eval never-export
...
(use-package ob-plantuml
  ...
  (when-let* ((plantuml-executable (executable-find "plantuml")))
    (setopt org-plantuml-jar-path plantuml-executable
